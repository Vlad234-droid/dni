...
const NetworkCreated: FC<SkinContentProps> = () => (
  <div>{'network created'}</div>
);

const NetworkUpdated: FC<SkinContentProps> = () => (
  <div>{'network updated'}</div>
);

const NetworkUrchived: FC<SkinContentProps> = () => (
  <div>{'network urchived'}</div>
);

const NetworkRemoved: FC<SkinContentProps> = () => (
  <div>{'network removed'}</div>
);
