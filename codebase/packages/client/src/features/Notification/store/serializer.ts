import { Notification, NotificationResponse, NetworkNotification, NetworkNotificationResponse } from '../config/types';

const toCamelCase = <T>(obj: Record<string, string>): T => {
