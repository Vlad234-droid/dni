...
export default [
  ...
  },
  {
    ...
    description:
      'Supporting all Parents & Carers across Tesco to find the support and advice they need as well as make working life easier, wherever you are in the business and whatever their goals.',
    image: {
