...
export default [
  {
    ...
    description: 'Bringing together former and current members of the armed forces, and their families. Ensuring they are supported with transition from military life, their families have the advice and support they need and helping colleagues who are reservists.',
    image: {
      src: armedImage,
    },
  },
