...
const AccessibilityInformation: FC = () => (
  <Wrapper data-testid='accessibility-information'>
    ...
    <Description>Diversity an Inclusion is committed to providing a website that is accessible to the widest possible audience. We actively work to ensure that this website is accessible and usable by people of all abilities.</Description>
    <Title>How to get the most accessible experience from this website</Title>
    <Description>Our website can be viewed on a range of different screen sizes and the size of text can be changed to suit different people.</Description>
    ...
    <Description>
      ...
      These guidelines are the internationally recognised benchmark for building accessible websites.
      The Web Content Accessibility Guidelines explain how to make websites more accessible for people with disabilities.
    ...
    <Description>
      ...
      The site displays correctly in all popular web browsers, and will continue to work in older browsers.
      In addition this website uses JavaScript and PDFs.
      These technologies are not relied upon and the website works well without them.
    </Description>
  </Wrapper>
);
