...
describe('<PostCreate />', () => {
  ...
  describe('#render', () => {
    ...
    it('should render title input, story input, confirmation checkbox and policy link', () => {
      ...
      expect(getByText('I agree to provide my personal story/data for the publication within this network, including the moderation version of my story')).toBeInTheDocument();
