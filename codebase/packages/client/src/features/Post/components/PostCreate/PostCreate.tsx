      ...
      <form onSubmit={handleSubmit(submitForm)} noValidate>
        ...
        <FieldWrapper>
          <FormGroup errorMessage={errors['confirm']?.message} error={Boolean(errors['confirm']?.message)}>
            <CheckboxWithLabel
              id='confirm'
              labelText='I agree to provide my personal story/data for the publication within this network I understand that this story may be shared in other locations, including the moderation version of my story. Please remember to include you Name & Location.'
              checked={isAccepted}
