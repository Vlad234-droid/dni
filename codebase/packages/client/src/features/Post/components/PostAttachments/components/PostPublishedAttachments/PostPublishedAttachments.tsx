...
const PostPublishedAttachments: FC<PostPublishedAttachmentsProps> = ({
  attachments,
}) => {
  return (
    <PostPublishedAttachmentsWrapper
      data-testid={postPublishedAttachmentsTestId}
    >
      {attachments.map((attachment) => {
        return (
          <PostPublishedAttachment key={attachment.name} {...attachment} />
        );
      })}
    </PostPublishedAttachmentsWrapper>
  );
