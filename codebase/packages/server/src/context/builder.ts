...
export type ColleagueSessionData = BasicUserData &
  ExtendedSessionData & { groups: string[] };

export type ColleagueRequestCtx = RequestCtx<
  ColleagueContextConfig,
  ColleagueSessionData
>;

export const buildContext: (
  config: ProcessConfig,
) => ContextProvider<ColleagueContextConfig, ColleagueSessionData> = (
  config: ProcessConfig,
) => (req, res) => ({
  identityUserToken: () => {
