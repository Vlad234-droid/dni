...
export class Backfill_population_2 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const stream = createReadStream(path.join(__dirname, 'data', 'DNI_backfill_population_20211129.csv'));
