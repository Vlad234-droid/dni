...
@Index('d_u_subscription__pk', ['colleagueUuid', 'subscriptionEntity', 'subscriptionEntityId'], { unique: true })
export class DniUserSubscription {
  ...
  @PrimaryColumn('enum', { name: 'subscription_entity', enum: DniEntityTypeEnum })
